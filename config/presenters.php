...
return [
    ...
    */
    ...
    blogCms\Page::class => blogCms\Presenters\PagePresenter::class,
    blogCms\Post::class => blogCms\Presenters\PostPresenter::class,
    blogCms\User::class => blogCms\Presenters\UserPresenter::class,
];
