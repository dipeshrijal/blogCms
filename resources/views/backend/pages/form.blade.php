...
@section('title', $page->exists ? 'Editting ' . $page->title : 'Create New Page')
@section('content')
{!! Form::model($page, [
...
<div class="form-group">
  ...
  <p class="help-block">This name is used to generate links to page.</p>
</div>
...
<div class="form-group row">
  ...
  <div class="col-md-5">
    {!! Form::select('orderPage', ['' => ''] + $orderPages->lists('paded_title', 'id')->toArray(), null, ['class' => 'form-control']) !!}
  </div>
</div>
<div class="form-group">
  {!! Form::label('content') !!}
